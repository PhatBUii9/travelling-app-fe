...
const SelectRestaurantsScreen = () => {
  ...
  const data = mockRestaurants.filter((restaurant) =>
  ...
  return (
    <>
      ...
      <ScreenContainer scrollable={false}>
                ...
                <View className="mt-1 mb-8">
                  <View className="items-center mx-8 mb-6">
                    ...
                    <Text className="text-base text-center font-JakartaMedium text-secondary-700 mb-3">
                      {`Select your preferred dining spots in ${current.cityName.toString()}`}
                    </Text>
                  ...
                  <Text className="text-heading-md font-JakartaSemiBold mb-5">
                    Popular Restaurants
                  </Text>
                </View>
              }
        ...
        <BottomStickyButton title="Continue" onPress={handleContinue} />
      </ScreenContainer>
    </>
  );
};
